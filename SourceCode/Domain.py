...
class OneDimDomain(AbstractDomain, AbstractPlot):
...
class TwoDimDomain(AbstractDomain, AbstractPlot):
    def __init__(
        self,
    ...
    def plot_function(self, function: Callable):
        ...
        ax.plot_surface(*dom_vals, f_vals, cmap="viridis", edgecolor="green")
...
class ThreeDimDomain(AbstractDomain, AbstractPlot):
    def __init__(
        self,
        x_left: Union[float, int],
        x_right: Union[float, int],
